...
const RegisterForm = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
      <>
      <dialog open className="min-w-[400px] max-w-[700px] shadow-[0_0_50px_0_rgba(0,0,0,0.2)] rounded-2xl py-12 px-14 bg-[#262935] fixed z-[2000] inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <FormProvider {...methods}>
          <form action="" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col mb-5">
              <InputText label="Role" fieldName="role" type="text" />
            </div>
            <div className="flex flex-col mb-5">
              <InputText label="Password" fieldName="password" type="password" />
            </div>
