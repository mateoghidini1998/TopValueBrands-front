          ...
          <tr key={product.seller_sku} className="py-6 stroke-1 stroke-[#393E4F] flex items-center h-[65px] w-full text-white bg-transparent border-b border-b-[#393E4F]">
            ...
            <td className="w-[5%] text-xs font-medium text-center flex justify-center">
              {editingRow[product.seller_sku] ? (
                <input name="product_cost" type="text"className="w-2/3 p-1 rounded-lg text-center text-[#55597D] bg-[#262935] border-[1px] border-solid border-[#393E4F]" value={editData.product_cost} onChange={e => onChange(e)} />
              ) : (
            ...
            <td className="w-[10%] text-xs font-medium text-center flex justify-center">
              {editingRow[product.seller_sku] ? (
                <input name="supplier_name" type="text"className="w-2/3 p-1 rounded-lg text-center text-[#55597D] bg-[#262935] border-[1px] border-solid border-[#393E4F]" value={editData.supplier_name} onChange={e => onChange(e)} />
              ) : (
            ...
            <td className="w-[10%] text-xs font-medium text-center flex justify-center">
              {editingRow[product.seller_sku] ? (
                <input name="supplier_item_number" type="text"className="w-2/3 p-1 rounded-lg text-center text-[#55597D] bg-[#262935] border-[1px] border-solid border-[#393E4F]" value={editData.supplier_item_number} onChange={e => onChange(e)} />
              ) : (
            ...
            <td className="w-[5%] text-xs font-medium text-center flex justify-center">
              {editingRow[product.seller_sku] ? (
                <input name="pack_type" type="text" className="w-2/3 p-1 rounded-lg text-center text-[#55597D] bg-[#262935] border-[1px] border-solid border-[#393E4F]" value={editData.pack_type} onChange={e => onChange(e)} />
              ) : (
                product.pack_type
              )}
            </td>
            ...
            <td className="w-[5%] text-xs font-medium text-center">{product.Inbound_to_FBA}</td>
              <td className="w-[10%] text-xs font-medium text-center relative">
                
                {
                  !editingRow[product.seller_sku]
                  ?
              <button onClick={() => handleToggleActions(product.seller_sku, product)}>
                  <DotsSVG/>
              </button>
                    :
