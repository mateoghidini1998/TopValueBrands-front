...
const ConfirmAlert = forwardRef(function ConfirmAlert({ message, onConfirm, onCancel, onClose, confirmText = AlertOptions.CONFIRM, cancelText = AlertOptions.CANCEL }: ConfirmAlertProps, ref)  {
  ...
  return (
    <>
        <dialog open ref={dialog} className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[320px] h-[226px] bg-[#262935] z-[2000] flex flex-col items-center justify-center gap-6 px-[2rem] rounded-md">
