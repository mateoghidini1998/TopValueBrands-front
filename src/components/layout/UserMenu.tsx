  ...
  if (user) {
    return (
      <div className="relative">
        ...
        <div
          className={`text-black absolute right-[5px] top-[30px] bg-dark-2 dark:border-[#393E4F] border-[1px] border-solid border-[#eff1f3] mt-2 w-[182px] dark:text-white  rounded-md box-border shadow-[0_3px_80px_0px_rgba(0,0,0,0.3)] transition-max-h duration-[0.6s] ease-in-out overflow-hidden dark:bg-dark-2 ${
