    ...
    <main className="flex w-full min-h-screen flex-col items-center">
      ...
      <table className="w-full ">
        <tr className="py-6 stroke-1 stroke-[#393E4F] flex items-center h-[60px] w-full text-white bg-[#262935]">
          <th className="w-[20%] text-xs font-medium text-center">Product</th>
        ...
        {
          Array.isArray(products) && products.slice(0, 15).map((product, index)    => (
          <tr key={index} className="py-6 stroke-1 stroke-[#393E4F] flex items-center h-[60px] w-full text-white bg-transparent border-b border-b-[#393E4F]">
            ...
            <td className="w-[10%] text-xs font-medium text-center">{product.product_cost}</td>
            ...
            <td className="w-[10%] text-xs font-medium text-center">{product.pack_type}</td>
